	...
	<body>
		...
		<header class="w3-container w3-teal">
		  ...
		  <?php
            ...
            <form action="update_post_process.php?did=<?php echo $row['donate_id']?>" method="POST" enctype="multipart/form-data" class="w3-container w3-border w3-padding w3-border" >
            
            <p>
            <label>Item Name</label>
            <input class="w3-input w3-border w3-validate" type="text" name="item_name" value="<?php echo $row['name']; ?> "/> </p>
            ...
            <input class="w3-input w3-border w3-validate" type="text" name="item_desc" value="<?php echo $row['area']; ?> "/> </p><br/>
