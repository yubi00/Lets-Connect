	...
	<body>
		...
		<div class="w3-container w3-text-RED">
		  ...
		  <?php
				...
				$result_array = mysql_query("SELECT * FROM donate1 d, signup1 s where d.donate_id = s.id");
				if(!result_array)
				{
					die("query failed");
				}
				...
				?>
                <a href="edit_post.php?did=<?php echo$row['donate_id']?>"><button class="w3-btn w3-teal">Update </button></a>
					</td>
                    <td>
