...
<nav class="navbar " style="background-color:#6AF1DE;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <li><a href="login/logout.php">LOGOUT<span class="glyphicon glyphicon-envelope"></span></a></li>
      ...
      <form class="navbar-form navbar-left" role="sfarch">
