...
<div class="well " style="margin-left:20px;">
    <div class="row">
        <form action="signup/insert_contact.php" method="post" enctype="multipart/form-data" role="form">
            <div class="col-lg-6 col-md-offset-3">
               ...
               <h1>CONTACT FORM</h1>
                ...
                <div class="form-group">
                    <label >ADDRESS</label>
                    <div class="input-group">
                        <input type="text"  name="txt_address"class="form-control" id="InputEmailSecond" name="InputEmail" placeholder="address" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div >
                    ...
                    <div class="input-group">
                        <input type="text"  name="txt_username"class="form-control" id="InputEmailSecond" name="InputEmail" placeholder="city" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                 <div >
                    ...
                    <div class="input-group">
                        <input type="text"  name="txt_password"class="form-control" id="InputEmailSecond" placeholder="nationality" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
